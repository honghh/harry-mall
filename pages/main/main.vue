	...
	<view>
		...
		<view class="bg-gradual-orange myHead" :style="[{paddingTop:(CustomBar + 10) + 'px'}]">
			<view class="cu-list menu-avatar" v-if="isLogin">
				<view class="cu-item">
					<view class="cu-avatar round lg" style="background-image:url(https://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTIpewOl8eYiaXGKMbMm1qG7ofHHibULbeaLcXPWhPfyZesibNhtibLvVuS5nOLR5PaVEIJnEHpbO7BnBA/132);"></view>
					<view class="content">
						<view class="text-white">Harry-Mall</view>
	...
	export default {
		data() {
			return {
				...
				topicList: [{
					title: '免费领面膜',
					img: 'https://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTIpewOl8eYiaXGKMbMm1qG7ofHHibULbeaLcXPWhPfyZesibNhtibLvVuS5nOLR5PaVEIJnEHpbO7BnBA/132',
					isGet: true
				}, {
					title: '免费领眉笔',
					img: 'https://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTIpewOl8eYiaXGKMbMm1qG7ofHHibULbeaLcXPWhPfyZesibNhtibLvVuS5nOLR5PaVEIJnEHpbO7BnBA/132',
